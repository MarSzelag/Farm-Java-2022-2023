        ...
        if (this.weeksToHarvest > 0) {
            ...
            if (this.plant.equals(farm.getCorn().getClass())) {
                if (farm.getBarn().getCapacityOfOneBuilding() * farm.getBarn().getQuantityOfThisBuildingType() - farm.getBarn().kgOfPlantsStoredInBarn(farm) >= this.haSown * this.plant.getHarvestsFromHaKg()) {
                    farm.setCorn(farm.getCorn().getStoredInKg() + this.haSown * this.plant.getHarvestsFromHaKg() * this.eventsDamages);
            ...
            if (this.plant.equals(farm.getLatePotato().getClass())) {
                if (farm.getBarn().getCapacityOfOneBuilding() * farm.getBarn().getQuantityOfThisBuildingType() - farm.getBarn().kgOfPlantsStoredInBarn(farm) >= this.haSown * this.plant.getHarvestsFromHaKg()) {
                    farm.setLatePotato(farm.getLatePotato().getStoredInKg() + this.haSown * this.plant.getHarvestsFromHaKg() * this.eventsDamages);
                    System.out.println("W zbiorach zebrano " + this.haSown * this.plant.getHarvestsFromHaKg() + "kg kukurydzy.");
            ...
            if (this.plant.equals(farm.getLateRape().getClass())) {
                if (farm.getBarn().getCapacityOfOneBuilding() * farm.getBarn().getQuantityOfThisBuildingType() - farm.getBarn().kgOfPlantsStoredInBarn(farm) >= this.haSown * this.plant.getHarvestsFromHaKg()) {
                    farm.setLateRape(farm.getLateRape().getStoredInKg() + this.haSown * this.plant.getHarvestsFromHaKg() * this.eventsDamages);
                    System.out.println("W zbiorach zebrano " + this.haSown * this.plant.getHarvestsFromHaKg() + "kg kukurydzy.");
            ...
            if (this.plant.equals(farm.getLateRye().getClass())) {
                if (farm.getBarn().getCapacityOfOneBuilding() * farm.getBarn().getQuantityOfThisBuildingType() - farm.getBarn().kgOfPlantsStoredInBarn(farm) >= this.haSown * this.plant.getHarvestsFromHaKg()) {
                    farm.setLateRye(farm.getLateRye().getStoredInKg() + this.haSown * this.plant.getHarvestsFromHaKg() * this.eventsDamages);
                    System.out.println("W zbiorach zebrano " + this.haSown * this.plant.getHarvestsFromHaKg() + "kg kukurydzy.");
            ...
            if (this.plant.equals(farm.getSpringBarley().getClass())) {
                if (farm.getBarn().getCapacityOfOneBuilding() * farm.getBarn().getQuantityOfThisBuildingType() - farm.getBarn().kgOfPlantsStoredInBarn(farm) >= this.haSown * this.plant.getHarvestsFromHaKg()) {
                    farm.setSpringBarley(farm.getSpringBarley().getStoredInKg() + this.haSown * this.plant.getHarvestsFromHaKg() * this.eventsDamages);
                    System.out.println("W zbiorach zebrano " + this.haSown * this.plant.getHarvestsFromHaKg() + "kg kukurydzy.");
            ...
            if (this.plant.equals(farm.getWhiteBeet().getClass())) {
                if (farm.getBarn().getCapacityOfOneBuilding() * farm.getBarn().getQuantityOfThisBuildingType() - farm.getBarn().kgOfPlantsStoredInBarn(farm) >= this.haSown * this.plant.getHarvestsFromHaKg()) {
                    farm.setWhiteBeet(farm.getWhiteBeet().getStoredInKg() + this.haSown * this.plant.getHarvestsFromHaKg() * this.eventsDamages);
                    System.out.println("W zbiorach zebrano " + this.haSown * this.plant.getHarvestsFromHaKg() + "kg kukurydzy.");
            ...
            if (this.plant.equals(farm.getWinterWheat().getClass())) {
                if (farm.getBarn().getCapacityOfOneBuilding() * farm.getBarn().getQuantityOfThisBuildingType() - farm.getBarn().kgOfPlantsStoredInBarn(farm) >= this.haSown * this.plant.getHarvestsFromHaKg()) {
                    farm.setWinterWheat(farm.getWinterWheat().getStoredInKg() + this.haSown * this.plant.getHarvestsFromHaKg() * this.eventsDamages);
                    System.out.println("W zbiorach zebrano " + this.haSown * this.plant.getHarvestsFromHaKg() + "kg kukurydzy.");
